...
<Note>
Hermes needs its **own bot tokens** — separate from the OpenClaw bot. Create a second Discord application at [discord.com/developers](https://discord.com/developers/applications) for Hermes. Having two bots lets you address them independently in Discord (`@Hermes` vs `@Mike`).
</Note>
