...
| `SLACK_BOT_TOKEN` | Slack bot user OAuth token (`xoxb-...`) — used for sending replies and MCP |
| `SLACK_SIGNING_SECRET` | Slack app signing secret — required to verify inbound @mention events |
